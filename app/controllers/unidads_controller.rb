class UnidadsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @unidad.save
        format.html { redirect_to unidad_url(@unidad), notice: "Unidad was successfully created." }
  ...
  def update
    respond_to do |format|
      if @unidad.update(unidad_params)
        format.html { redirect_to unidad_url(@unidad), notice: "Unidad was successfully updated." }
